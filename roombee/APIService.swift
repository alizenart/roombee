...
//    var events: [CalendarEvent]
    ...
    // Update event approval
    func updateEventApproval(eventId: String, newApprovalStatus: String, completion: @escaping (Bool, Error?) -> Void) {
        let endpoint = "/UpdateEventApproval"  // Corrected to match API Gateway's resource path
